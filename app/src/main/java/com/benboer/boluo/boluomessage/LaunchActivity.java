...
import static net.qiujuer.genius.res.Resource.Color;
...
//                skip();
    ...
    private void startAnim(float endProgress, final Runnable endCallback) {
        ...
        // 运算当前进度的颜色
        @SuppressLint("RestrictedApi") ArgbEvaluator evaluator = ArgbEvaluator.getInstance();
        @SuppressLint("RestrictedApi") int endColor = (int) evaluator.evaluate(endProgress, mBgDrawable.getColor(), finalColor);
        // 构建一个属性动画
