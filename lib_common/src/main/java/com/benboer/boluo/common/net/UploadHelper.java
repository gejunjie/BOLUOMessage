...
import com.benboer.boluo.common.util.HashUtil;

import java.io.File;
import java.util.Date;

/**
 * Created by BenBoerBoluojiushiwo on 2019/4/2.
 */
public class UploadHelper {
    ...
    private static OSS getClient() {
        // 明文设置secret的方式,只在测试时使用
        OSSCredentialProvider credentialProvider = new OSSPlainTextAKSKCredentialProvider(
                "LTAIYQD07p05pHQW", "2txxzT8JXiHKEdEjylumFy6sXcDQ0G");
        return new OSSClient(BoLuo.getApplicationContext(), ENDPOINT, credentialProvider);
    }
